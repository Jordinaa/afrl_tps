...
class FlightEnvelopeSupervisor(FlightEnvelopeAssessment):
    ...
    def init_csv(self):
        ...
        self.csv_path = f"/home/taranto/catkin_ws/src/supervisor/flighttest/datasitl/drone_{timestamp}.csv"
        self.csv_file = open(self.csv_path, "w", newline="")
        self.csv_writer = csv.writer(self.csv_file)
        self.csv_writer.writerow([timestamp, "true_velocity", "n_true", "predicted_velocity", "predicted_n", "bounds_crossed"])
